...
public class ColumnTable {
	...
	public static final String RESULT = "column_table.pdf";
	...
	public void createPdf(String filename) throws Exception {
		...
		for (Date day : days) {
			...
			while (ColumnText.hasMoreText(status)) {
				...
				if (count == 0) {
					height = addHeaderTable(document, day,
	 ...
	 * 
	 * @param document
	 *            The document to which you want to add a header table
	 * @param day
	 *            The day that needs to be shown in the header table
	 * @param page
	 *            The page number that has to be shown in the header
