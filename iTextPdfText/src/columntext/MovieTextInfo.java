...
public class MovieTextInfo extends MovieTimeBlocks {
	...
	public static String[] TIME = { "09:30", "10:00", "10:30", "11:00",
			"11:30", "12:00", "00:30", "01:00", "01:30", "02:00", "02:30",
			"03:00", "03:30", "04:00", "04:30", "05:00", "05:30", "06:00",
			"06:30", "07:00", "07:30", "08:00", "08:30", "09:00", "09:30",
			"10:00", "10:30", "11:00", "11:30", "12:00", "00:30", "01:00" };
	...
	protected void drawInfo(PdfContentByte directcontent) {
		...
		directcontent.showTextAligned(Element.ALIGN_CENTER, "The Majestic", x,
				y, 90);
		y = OFFSET_BOTTOM + HEIGHT_LOCATION * 4f;
		directcontent.showTextAligned(Element.ALIGN_CENTER, "Googolplex", x, y,
				90);
		y = OFFSET_BOTTOM + HEIGHT_LOCATION * 7.5f;
		directcontent.showTextAligned(Element.ALIGN_CENTER, "Cinema Paradiso",
				x, y, 90);
		...
		for (int i = 0; i < TIMESLOTS; i++) {
			...
			directcontent
					.showTextAligned(Element.ALIGN_LEFT, TIME[i], x, y, 45);
		}
	...
	protected void drawDateInfo(Date day, int d, PdfContentByte directcontent) {
		...
		x = OFFSET_LOCATION;
		y = OFFSET_BOTTOM + HEIGHT + 24;
		directcontent.showTextAligned(Element.ALIGN_LEFT, "Day " + d, x, y, 0);
		x = OFFSET_LEFT + WIDTH;
		directcontent.showTextAligned(Element.ALIGN_RIGHT, day.toString(), x,
				y, 0);
		directcontent.endText();
	}
	...
	protected void drawMovieInfo(Screening screening,
			PdfContentByte directcontent) throws DocumentException {
	...
	/**
	 * Constructor for the MovieCalendar class; initializes the base font
	 * object.
	 * 
	 * @throws IOException
	 * @throws DocumentException
