...
public class MovieTimeTable {
	...
	/** The resulting PDF. */
	public static final String RESULT = "time_table.pdf";
	...
	protected void drawTimeTable(PdfContentByte directcontent) {
		...
		directcontent.moveTo(OFFSET_LOCATION + WIDTH_LOCATION / 2,
				OFFSET_BOTTOM);
		directcontent.lineTo(OFFSET_LOCATION + WIDTH_LOCATION / 2,
	 ...
	 * 
	 * @param directcontent
	 *            the canvas to which the time table has to be drawn.
	 */
