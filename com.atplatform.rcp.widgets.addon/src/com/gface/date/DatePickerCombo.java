...
public final class DatePickerCombo extends Composite {
	 ...
	 * @see Widget#getStyle()
	 */
	public DatePickerCombo(Composite parent, int swtStyle) {
		super(parent, compositeStyle(swtStyle));
		initialize(swtStyle, 0);
	}

	public DatePickerCombo(Composite parent, int swtStyle, int dpStyle) {
		super(parent, compositeStyle(swtStyle));
		initialize(swtStyle, dpStyle);
	}

	private void initialize(int swtStyle, int dpStyle) {
	...
	static int compositeStyle(int style) {
	...
	private int textStyle(int style) {
	...
	private int buttonStyle(int style) {
	 ...
	 *            SWT keycode of key
	 */
	public void addPickerOpenKey(int keyCode) {
