...
public class MainUI {
	...
	protected void createContents() {
		...
		SystemButton menuBtn = new SystemButton(winTitle, SWT.NONE,"/res/sysbtn_menu.png",4,"菜单",this,new Listener() {
		...
		SystemButton minBtn = new SystemButton(winTitle, SWT.NONE, "/res/sysbtn_min.png", 4, "最小化",this,new Listener() {
		...
		SystemButton closeBtn = new SystemButton(winTitle, SWT.NONE, "/res/sysbtn_close.png", 4, "关闭",this,new Listener() {
